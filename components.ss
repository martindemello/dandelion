...
(define editable-text%
  (class text%
    ...
    (define/augment (after-insert a b) (check-height) (send application add-undo this))
    (define/augment (after-delete a b) (check-height) (send application add-undo this))
